...
public class CPasswordFieldUI extends BasicPasswordFieldUI {
    ...
    public static ComponentUI createUI(JComponent c) {
        return new CPasswordFieldUI();
    }

    private Color getBackground(JCPasswordField field) {
    ...
    protected void paintBackground(Graphics g) {
        ...
        if ((editor instanceof JCPasswordField)) {
            JCPasswordField field = (JCPasswordField) editor;
