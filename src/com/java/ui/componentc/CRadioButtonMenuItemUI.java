...
public class CRadioButtonMenuItemUI extends CMenuItemUI {
    private static final Icon DEFAULT_ICON = UIResourceManager
            .getIcon("CheckBoxMenuItemSelectedIcon");

    public static ComponentUI createUI(JComponent c) {
        return new CRadioButtonMenuItemUI();
    }
    ...
    protected Color getTextColor() {
        ...
        if ((this.menuItem instanceof JCRadioButtonMenuItem)) {
            JCRadioButtonMenuItem cItem = (JCRadioButtonMenuItem) this.menuItem;
